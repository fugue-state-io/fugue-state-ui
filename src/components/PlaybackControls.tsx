    ...
    <div className="bg-gray-900">
        <div className='max-w-md grid grid-cols-2 text-center mx-auto relative'>
          ...
          <div className='items-center px-4 py-2 rounded-md'>
            <span onClick={() => props.setPlayingCallback(!props.playing)} className='relative mx-auto inline-flex items-center px-4 py-2 mx-2 rounded-md shadow-lg bg-pink-400 hover:bg-pink-700 shadow-lg'>
              <span id="play" className='text-white font-bold'>{!props.playing ? "Play" : "Pause"}</span>
            </span>
          </div>
        </div>
      </div>
