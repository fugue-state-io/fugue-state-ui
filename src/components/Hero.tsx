  ...
  return (
    <>
      ...
      <Features>
        ...
        <Feature svg='' textColorClass="text-pink-400" svgColorClass="bg-pink-400" title='Playback Engine' description='Speed up or Slow Down, Select a timespan and loop.'/>
        <Feature svg='' textColorClass="text-green-400" svgColorClass="bg-green-400" title='Practice Log' description="Automatically Record what you've practiced, how long, and when."/>
        <Feature svg='' textColorClass="text-pink-400" svgColorClass="bg-pink-400" title='Pitch Drone' description='A simple tool to drone a single pitch to aid in transcription.'/>
        <Feature svg='' textColorClass="text-green-400" svgColorClass="bg-green-400" title='Audio Manipulation' description='Pitch Transposition, Metric Modulation, Karaoke Mode, and Equalization for audio files.'/>
