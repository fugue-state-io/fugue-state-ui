    ...
    <>
      ...
      <Features>
        <Feature svg={
          ...
          textColorClass="text-green-400" svgColorClass="bg-green-400" title='Metronome' description='Practice alone or for use in tempo mapping a song. Metric modulation.'/>
