    ...
    <>
      ...
      <Features>
        <Feature
          ...
          title="Metronome"
          description="Practice alone or for use in tempo mapping a song. Metric modulation."
        />
        <Feature
          svg={
            <svg
        ...
        <Feature
          ...
          svgColorClass="bg-green-400"
          title="Practice Log"
          description="Automatically Record what you've practiced, how long, and when."
        />
        <Feature
          svg={
            <svg
          ...
          svgColorClass="bg-pink-400"
          title="Pitch Drone"
          description="A simple tool to drone a single pitch to aid in transcription."
        />
        <Feature
          svg={
            <svg
